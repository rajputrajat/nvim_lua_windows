...
Group.new('string', colors.light_purple, groups.string, styles.italic )
...
Group.new('type', groups.type, groups.type, groups.type - styles.italic)
Group.new('colorcolumn', colors.none, colors.grey)
